...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "memory.sif.graphPath": "SIF Graph Path",
  "memory.sif.maxContextPointers": "SIF Max Context Pointers",
  "memory.sif.minContextWeight": "SIF Min Context Weight",
  "memory.sif.decayHalfLifeDays": "SIF Decay Half-Life (days)",
  auth: "Auth",
